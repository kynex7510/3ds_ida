...
enum Result {
  ...
  OS_INVALID_COMMAND_HEADER = 0xD900182F,
  OS_WRONG_ARGUMENT_48 = 0xD9001830,
  OS_WRONG_ARGUMENT_49 = 0xD9001831,
...
enum ThreadContextControlFlags {
  ...
  THREADCONTEXT_CONTROL_CPU_REGS =
      THREADCONTEXT_CONTROL_CPU_GPRS | THREADCONTEXT_CONTROL_CPU_SPRS,

  THREADCONTEXT_CONTROL_FPU_GPRS = 0x04,
  THREADCONTEXT_CONTROL_FPU_SPRS = 0x08,
  THREADCONTEXT_CONTROL_FPU_REGS =
      THREADCONTEXT_CONTROL_FPU_GPRS | THREADCONTEXT_CONTROL_FPU_SPRS,

  THREADCONTEXT_CONTROL_ALL =
      THREADCONTEXT_CONTROL_CPU_REGS | THREADCONTEXT_CONTROL_FPU_REGS,
