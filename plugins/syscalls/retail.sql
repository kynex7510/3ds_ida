...
(0x08, 'CreateThread', 'SvcResultHandle __usercall svcCreateThread@<r0, r1>(s32 threadPriority@<r0>, ThreadFunc entrypoint@<r1>, u32 arg@<r2>, u32* stackTop@<r3>, s32 processorId@<r4>);'),
...
(0x12, 'Run', 'Result __usercall svcRun@<r0>(Handle process@<r0>, s32 priority@<r1>, u32 stackSize@<r2>, s32 argc@<r3>, u16* argv@<r4>, u16* envp@<r5>);'),
(0x13, 'CreateMutex', 'SvcResultHandle __usercall svcCreateMutex@<r0, r1>(bool initiallyLocked@<r1>);'),
(0x14, 'ReleaseMutex', 'Result __usercall svcReleaseMutex@<r0>(Handle handle@<r0>);'),
(0x15, 'CreateSemaphore', 'SvcResultHandle __usercall svcCreateSemaphore@<r0, r1>(s32 initialCount@<r1>, s32 maxCount@<r2>);'),
(0x16, 'ReleaseSemaphore', 'SvcResult32 __usercall svcReleaseSemaphore@<r0, r1>(Handle semaphore@<r1>, s32 releaseCount@<r2>);'),
(0x17, 'CreateEvent', 'SvcResultHandle __usercall svcCreateEvent@<r0, r1>(ResetType resetType@<r1>);'),
...
(0x1A, 'CreateTimer', 'SvcResultHandle __usercall svcCreateTimer@<r0, r1>(ResetType resetType@<r1>);'),
...
(0x1E, 'CreateMemoryBlock', 'SvcResultHandle __usercall svcCreateMemoryBlock@<r0, r1>(MemPerm otherPerm@<r0>, u32 addr@<r1>, u32 size@<r2>, MemPerm myPerm@<r3>);'),
(0x1F, 'MapMemoryBlock', 'Result __usercall svcMapMemoryBlock@<r0>(Handle memblock@<r0>, u32 addr@<r1>, MemPerm myPerm@<r2>, MemPerm otherPerm@<r3>);'),
