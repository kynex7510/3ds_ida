...
SYSCALL_TYPES = {
    ...
    0x1E: "SvcResultHandle __usercall svcCreateMemoryBlock@<r0, r1>(u32 addr@<r1>, u32 size@<r2>, MemPerm my_perm@<r3>, MemPerm other_perm@<r4>);",
    ...
    0x22: "Result __usercall svcArbitrateAddress@<r0>(Handle arbiter@<r0>, u32 addr@<r1>, ArbitrationType type@<r2>, s32 value@<r3>, s64 timeout_ns@<r5, r4>);",
    0x23: "Result __usercall svcCloseHandle@<r0>(Handle handle@<r0>);",
    0x24: "Result __usercall svcWaitSynchronization@<r0>(Handle handle@<r0>, s64 nanoseconds@<r2, r1>);",
    0x25: "SvcResult32 __usercall svcWaitSynchronizationN@<r0, r1>(const Handle* handles@<r1>, s32 handles_num@<r2>, bool wait_all@<r3>, s64 nanoseconds@<r4, r0>);",
    0x27: "SvcResultHandle __usercall svcDuplicateHandle@<r0, r1>(Handle original@<r1>);",
    0x28: "u64 __usercall svcGetSystemTick@<r1, r0>(void);",
    0x29: "SvcResult64 __usercall svcGetHandleInfo@<r0, r2, r1>(Handle handle@<r1>, u32 param@<r2>);",
    0x2A: "SvcResult64 __usercall svcGetSystemInfo@<r0, r2, r1>(u32 type@<r1>, s32 param@<r2>);",
    0x2B: "SvcResult64 __usercall svcGetProcessInfo@<r0, r2, r1>(Handle process@<r1>, u32 type@<r2>);",
    0x2C: "SvcResult64 __usercall svcGetThreadInfo@<r0, r2, r1>(Handle thread@<r1>, ThreadInfoType type@<r2>);",
